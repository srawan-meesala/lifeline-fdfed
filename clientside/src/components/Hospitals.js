...
function Hospitals (){
    ...
    return(
     ...
     <div id="viewHosp" className="Hospitals-right-table">
        ...
        <div className ="AddHosp" onClick={handleAddClick} >Add  <FaPlus/>  </div>
                           ...
                           <table>
                                <thead>
                                  ...
                                  <tr key={hospital.id}>
                                    ...
                                    <td>
                                      <button className ="Hospitals-edit-icon" onClick={() => handleEdit(hospital.id)}><FaEdit /></button>
                                      <button className ="Hospitals-delete-icon" onClick={() => handleDelete(hospital.id)}><FaTrash /></button>
                                    </td>
                                  </tr>
                                ))}
                                  </tbody>
